...
export default function Picture() {
  ...
  const { image, setImage } = useDonationStore();
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Image style={{ width: 48, height: 48, marginBottom: 4 }} source={cameraImg} />

        <Text style={styles.title}>Add a picture</Text>
        <Text style={styles.subtitle}>
          A beautiful photo helps beneficiaries to quickly identify the donation.
        </Text>
        ...
        <View style={styles.tipRow}>
          <Image style={{ width: 25, height: 25 }} source={lampImg} />
          <Text style={styles.tipText}>
            Tip: photograph the food under good light to attract more beneficiaries.
          </Text>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingTop: 28,
    backgroundColor: "rgba(209,216,196,0.5)",
    paddingBottom: 40,
    minHeight: "100%",
  },
