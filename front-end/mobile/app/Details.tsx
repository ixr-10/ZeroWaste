...
const CATEGORIES = [
  ...
  { id: "dairy", label: "Milk Products", image: require("../assets/images/milk.png") , imageStyle: { width: 20, height: 20,  }},
  { id: "meat", label: "Meat & Fish", image: require("../assets/images/meat.png") , imageStyle: { width: 20, height: 20,  }},
  { id: "preserved", label: "Preserved Food", image: require("../assets/images/preserved food.png") , imageStyle: { width: 20, height: 20,  } },
  { id: "cooked", label: "Cooked Meals", image: require("../assets/images/cooked meals.png") , imageStyle: { width: 22, height: 22,  } },
  ...
  return (
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TextInput style={styles.textArea} placeholder="e.g: garden tomatoes, unsliced country bread..." placeholderTextColor="#aac0aa" multiline numberOfLines={4} value={description} onChangeText={setDescription} textAlignVertical="top" />
...
const styles = StyleSheet.create({
  ...
  footer: { paddingHorizontal: 24,paddingBottom: 45, gap: 10 ,backgroundColor:'white',marginTop:20},
