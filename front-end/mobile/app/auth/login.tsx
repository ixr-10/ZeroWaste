...
export default function LoginScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff', marginTop: 0 }}>
      {/* Custom header with logo on the right only */}
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#588157', opacity: 0.5, borderRadius: 20, padding: 12, paddingLeft: 38, marginBottom: 16, fontSize: 14 },
  ...
  button: { backgroundColor: '#588157', paddingHorizontal: 40, paddingVertical: 10, borderRadius: 25, alignItems: 'center', marginBottom: 24, alignSelf: 'center' },
